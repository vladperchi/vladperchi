...
Soy Vladimir, un desarrollador .NET con sede en Cali, Colombia, proactivo y creativo, enfocado en aplicaciones WebAPI usando (ASP) .NET Core y Stack relacionado con arquitectura limpia y buenas prácticas.
